        ...
        public async Task<IActionResult> ActualizarEstado(string id)
        {
            ...
            try
            {
                ...
                if(rol.Estado == false)
                {
                    ...
                    TempData["Mensaje"] = "Debe activar el estado del rol "+rol.Nombre + " en el módulo gestión de roles";
                }
                else
                {
        ...
        public async Task<IActionResult> Login(LoginViewModel loginViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                if (resultado.Succeeded)
                {
                    ...
                    UsuarioIdentity usuarioIdentity = await _usuariosService.ObtenerUsuarioId(usuario.Id);

                    if (rol.Contains("Administrador") || rol.Contains("Empleado") && usuarioIdentity.Estado == true) 
                    {
